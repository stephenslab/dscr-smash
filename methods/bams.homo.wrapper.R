# define your methods in .R files like this one in the methods subdirectory each method should take arguments input and args, like the example the output should be a list of the appropriate
# 'output' format (defined in the README)
