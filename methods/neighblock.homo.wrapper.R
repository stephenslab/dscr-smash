...
#runs wavelet denoising using the block thresholding method Neighblock in matlab, assuming constant variance
#inputs:
...
neighblock.homo.wrapper = function(input,args){
  ...
  system("matlab -nodisplay -nodesktop -r \"run('methods/neighblock_matlab.m')\"")
